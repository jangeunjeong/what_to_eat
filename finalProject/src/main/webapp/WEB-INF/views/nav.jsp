...
<body class="goto-here">
								...
								<div
									...
									<div class="col-lg-12 d-block">
										<div class="row d-flex">
											...
											<div align="right">
												<button type="button" class="btn btn-baby" id="_btnLogout">Logout</button>
												<button type="button" class="btn btn-baby" id="_btnMyinfo">MyInfo</button>
											</div>
										</div>
									</div>
								</div>
	...
	<nav
		...
		id="ftco-navbar">
		<div class="container">
			<a href="./" target="_self"><img src="images/green_ver.png" width="100px" height="100px" alt="메인페이지 바로가기"></a>
				...
				<ul class="navbar-nav ml-auto">
					...
					<a class="nav-link dropdown-toggle" href="#" id="dropdown04"
						...
						<div class="dropdown-menu" aria-labelledby="dropdown04">
							...
							<a class="dropdown-item" href="loadMap.do">홈페이지 안내</a>
