...
<form id="_form" method="post" action="./addnoticeaf.do">
	...
	<tr>
		...
		<td><input type="text" name="title" id="_title" size="100" maxlength="201" onkeyup="chk(this.id, 200 )"></td>
	</tr>
	<tr>
		<th style="text-align: right">내용&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<td><textarea rows="10" cols="103" size="1000" id="_wcontents" name="wcontents" maxlength="2001" onkeyup="chk(this.id, 2000 )"></textarea></td>
	</tr>
	</table>
</form>
	<hr/>
<div align="center">
<button id="_addbtn"><img src="images/alertadd.png" width="80" height="40px" alt="공지추가" style="align" /></button></div>
</div>
</div>
</div>
