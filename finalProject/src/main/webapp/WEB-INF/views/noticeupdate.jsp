...
<form id="_form" method="post" action="./updatenotice.do">
	...
	<tr>
		<td><input type="hidden" name="seq" size="100" value="${notice.seq}"></td>
	</tr>
	<tr>
		<th style="text-align: right">작성자&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<td><input type="text" name="writer" size="100" value="${notice.writer}"readonly="readonly"></td>
	</tr>
	<tr>
		<th style="text-align: right">제목&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<td><input type="text" id="_title" name="title" size="100" value="${notice.title}" maxlength="201" onkeyup="chk(this.id, 200 )"></td>
	</tr>
	<tr>
		<th style="text-align: right">내용&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<td><textarea rows="10" cols="103" id="_wcontents" name="wcontents" maxlength="2001" onkeyup="chk(this.id, 2000 )">${notice.wcontents}</textarea></td>
	</tr>
	...
	<hr/>
<div align="center">
	<button id="_addbtn" type="submit"><img src="images/alertupdate.png" width="80" height="40px" alt="공지수정" style="align" /></button></div>
</div>
</div>
</div>
